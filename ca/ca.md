...
### 🔑 Ключевые изменения от оригинальной инструкции
- **CN центра сертификации**: `REA2026-CA` (а не 2024!)
- **Корневой каталог**: `/etc/ca` (строго по заданию)
- **Версия ОС**: Astra Linux 1.7/1.8 (Debian-based), поэтому команды совместимы с Debian
- **SAN-сертификаты** обязательны для сервисов с несколькими доменами
